...
BUCKET_NAME = "nasa-neo-data-hist"
aws_access_key_id = ''
aws_secret_access_key = ''
s3_client = boto3.client('s3', aws_access_key_id=aws_access_key_id, aws_secret_access_key=aws_secret_access_key)
# start_date = datetime.today() - timedelta(days=365*10) #10 years data
# end_date = datetime.today()  # One-day range

start_date = datetime(2010, 1, 1)
end_date = datetime(2015, 1, 14)

def nasa_neo_data_api():
    ...
    while(current_date <= end_date):
        ...
        data_raw = data['near_earth_objects'][current_date.strftime('%Y-%m-%d')]
        
        
        #Calling Tranformation function
        tranformed_data = nasa_neo_data_transformation(total_count,data_raw,current_date)
        
        #Upoalding files to S3
        upload_to_s3(tranformed_data,current_date)
...
def nasa_neo_data_transformation(total_count,data_raw,current_date):
...
def upload_to_s3(data,current_date):
